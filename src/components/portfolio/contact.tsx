...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="relative pt-24 pb-24 px-6 md:pt-64 overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_100%,rgba(16,185,129,0.1),transparent_70%)] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center">
          <motion.div
            ...
            className="w-full"
          >
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full glass border-white/5 text-[10px] md:text-xs font-black uppercase tracking-[0.4em] text-primary mb-12">
            ...
            <h2 className="text-[12vw] sm:text-[14vw] md:text-[8rem] lg:text-[10rem] font-headline font-black mb-16 tracking-tighter leading-[0.8] text-gradient break-words">
              START A <br /> 
            ...
            <div className="flex justify-center">
              <Button 
                ...
                size="lg" 
                className="h-24 md:h-32 rounded-full px-12 md:px-20 text-xl md:text-3xl font-black bg-white text-black hover:bg-primary hover:text-black transition-all duration-700 group relative overflow-hidden shadow-2xl cursor-none"
                data-cursor="Initiate"
              >
                <span className="relative z-10 flex items-center gap-4">
                  Deploy Vision <ArrowRight className="w-6 h-6 md:w-8 md:h-8 group-hover:translate-x-2 transition-transform" />
                </span>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-2xl bg-[#050505]/95 backdrop-blur-3xl border-white/5 p-0 rounded-[3rem] shadow-2xl outline-none z-[5000] cursor-none overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-12 space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <Textarea 
                      ...
                      placeholder="Describe the landscape and requirements of your vision..."
                  ...
                  <Button 
                    type="submit" 
                    disabled={loading}
                    className="w-full h-20 rounded-full bg-primary text-black font-black uppercase tracking-[0.4em] text-sm hover:bg-accent transition-all group shadow-2xl relative overflow-hidden"
                  >
