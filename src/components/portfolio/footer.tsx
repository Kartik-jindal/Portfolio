        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 md:gap-12 pt-12 pb-12">
          <div className="col-span-1 lg:col-span-2 space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground/60 max-w-md text-xl md:text-2xl font-light leading-relaxed font-body">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-6 font-body">
              {['Home', 'Selected Work', 'About Story', 'Journal'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-muted-foreground/80 hover:text-primary transition-all flex items-center gap-3 group text-xl md:text-2xl">
                    {item}
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              <a href="mailto:hello@kartikjindal.com" className="block group">
                ...
                <span className="text-2xl md:text-3xl lg:text-4xl text-white font-headline border-b border-white/10 group-hover:border-primary transition-colors inline-block pb-1">
                  hello@kartikjindal.com
                </span>
              </a>
              <div className="pt-4">
                <a href="#" className="inline-flex items-center gap-3 text-xs uppercase tracking-[0.3em] font-black text-white/40 hover:text-white transition-colors py-4 px-8 rounded-full border border-white/5 glass">
