...
export const Experience = () => {
  ...
  return (
    <section id="experience" ref={scrollRef} className="py-24 px-6 md:py-48 bg-white/[0.01]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-24">
        <div className="lg:w-1/3 sticky top-32 h-fit">
          ...
          <h2 className="text-6xl font-headline font-black mb-10 tracking-tighter leading-none">Career <br /> <span className="text-outline italic">Path</span></h2>
            ...
            {experiences.map((exp, i) => (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-6 mb-8">
                  ...
                  <div className="text-muted-foreground text-xs font-black tracking-widest uppercase border border-white/10 px-6 py-2">
                    {exp.period}
                  </div>
                </div>
                <p className="text-muted-foreground text-xl leading-relaxed max-w-2xl font-light font-body">
                  {exp.desc}
                </p>
              </motion.div>
            ))}
