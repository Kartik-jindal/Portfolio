...
export const About = ({ initialData }: { initialData?: any }) => {
  ...
  return (
    <section id="about" className="py-24 md:py-48 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-primary/5 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          >
            <div className="space-y-6">
              ...
              <h2 className="text-4xl sm:text-5xl md:text-8xl font-headline font-black leading-[1.1] tracking-tighter">
            ...
            <div className="space-y-10 max-w-3xl">
              <p className="text-xl sm:text-2xl md:text-4xl text-white font-body font-light leading-snug">
                {content.narrative1}
              </p>
          ...
          <motion.div
            ...
            className="lg:col-span-5 space-y-8 lg:space-y-12 lg:pl-12"
          >
            <div className="glass p-6 sm:p-8 md:p-12 rounded-[2.5rem] border-white/5 space-y-12 relative overflow-hidden group">
            ...
            <div className="p-6 sm:p-8 md:p-12 border border-white/5 rounded-[2.5rem] bg-gradient-to-br from-primary/5 to-transparent">
