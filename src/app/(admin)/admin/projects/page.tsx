              ...
              <div className="flex items-center gap-8">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    <span className="text-[12px] font-black uppercase tracking-widest text-white/30">{project.type}</span>
                    <span className="w-1 h-1 rounded-full bg-white/10" />
                    <span className="text-[12px] font-black uppercase tracking-widest text-primary/60">{project.status}</span>
                  </div>
                </div>
              </div>
