...
import { Save, ArrowLeft, Image as ImageIcon, FileText, Globe, Plus, Trash2, Database, MessageSquare, Lightbulb, HelpCircle, RefreshCcw, AlertTriangle, Code, ChevronDown, ChevronUp, Bookmark, Link2 } from 'lucide-react';
