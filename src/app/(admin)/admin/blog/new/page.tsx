...
import { Save, ArrowLeft, FileText, Globe, Plus, Trash2, Database, MessageSquare, Lightbulb, HelpCircle, RefreshCcw, Code, ChevronDown, ChevronUp, Bookmark, Link2, Eye, Sparkles, AlertTriangle } from 'lucide-react';
