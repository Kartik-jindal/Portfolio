      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-5xl font-headline font-black italic tracking-tighter text-white">Draft Entry.</h1>
          </div>
        </div>
        <Button 
        ...
        >
          {loading ? 'Initializing...' : 'Save Draft'} <Save className="w-5 h-5 ml-2 group-hover:scale-110 transition-transform" />
        </Button>
      </header>
      ...
      <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="glass p-10 rounded-[2.5rem] border-white/5 space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea value={formData.summary} onChange={e => setFormData({ ...formData, summary: e.target.value })} className="bg-white/5 border-white/5 rounded-xl min-h-[100px]" placeholder="Brief teaser..." />
              </div>
              <div className="space-y-2">
        ...
        <div className="lg:col-span-4 space-y-10">
          <div className="glass p-8 rounded-[2rem] border-white/5 space-y-8">
            <h3 className="text-[10px] uppercase font-black tracking-widest text-white/40">Visual Context</h3>
            <div className="space-y-4">
