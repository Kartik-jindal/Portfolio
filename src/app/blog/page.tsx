                ...
                >
                  <Link href={`/blog/${post.slug || post.id}`} className="block relative z-10 p-8 md:p-12 rounded-[2rem] hover:bg-white/[0.02] border border-transparent hover:border-white/5 transition-all duration-500">
                    <div className="grid md:grid-cols-12 gap-10 items-center">
                      <div className="md:col-span-4 flex flex-col md:flex-row gap-8 items-start">
                        {/* Thumbnail Container */}
                        <div className="relative w-full md:w-32 lg:w-40 aspect-square rounded-2xl overflow-hidden bg-white/5 border border-white/5 shrink-0 group-hover:border-primary/30 transition-all duration-500 shadow-xl">
                           <Image 
                        ...
                        <div className="space-y-6 flex-1">
                          ...
                          <div className="flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-3 text-white/60 text-xs font-medium uppercase tracking-widest">
